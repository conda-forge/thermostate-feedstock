...
Once the `conda-forge` channel has been enabled, `thermostate` can be installed with:

```
conda install thermostate
```

It is possible to list all of the versions of `thermostate` available on your platform with:
